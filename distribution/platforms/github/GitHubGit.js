...
var d = (0, debug_1.debug)("GitHubGit");
/**
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, (0, diffToGitJSONDSL_1.diffToGitJSONDSL)(diff, commits)];
            }
        });
    });
}
exports.default = gitDSLForGitHub;
var gitHubGitDSL = function (github, json, githubAPI) {
...
exports.gitHubGitDSL = gitHubGitDSL;
var emptyGitJSON = function () { return ({
    commits: [],
    created_files: [],
    deleted_files: [],
    modified_files: [],
}); };
exports.emptyGitJSON = emptyGitJSON;
