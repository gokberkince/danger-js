...
var GitLabAPI = /** @class */ (function () {
    function GitLabAPI(repoMetadata, repoCredentials) {
        ...
        this.removeLabels = function () {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var mr, _a, labels_1, label, labels_2, index;
                var _b, _c;
                    ...
                    switch (_d.label) {
                        ...
                        case 1:
                            ...
                            for (_a = 0, labels_1 = labels; _a < labels_1.length; _a++) {
                                label = labels_1[_a];
                                labels_2 = mr.labels;
                                index = labels_2.indexOf(label);
                                if (index > -1) {
                                    (_b = mr.labels) === null || _b === void 0 ? void 0 : _b.splice(index, 1);
                                }
                            }
                            return [4 /*yield*/, this.updateMergeRequestInfo({ labels: (_c = mr.labels) === null || _c === void 0 ? void 0 : _c.join(",") })];
                        case 2:
                            _d.sent();
                            return [2 /*return*/, true];
                    }
